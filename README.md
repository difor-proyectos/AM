...
Hotfix V15: mejoras responsive móvil, topbars sin superposición, banner con más separación, títulos sin corte y refinamiento premium Black/White.


V16 overlay fix: barras superiores e internas ya no son fijas/pegajosas; ahora no tapan el contenido al deslizar.


V17: remaquetación total de barra superior móvil (vertical y horizontal) usando flex-wrap, con marca y utilidades arriba y navegación abajo para evitar solapamientos.
