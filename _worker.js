...
async function handleAssets(request, env) {
  ...
  if (request.method === "POST") {
    ...
    if (!file.type.startsWith("image/") && !file.type.startsWith("video/") && file.type !== "application/pdf") return jsonWithCors({ error: "Solo se aceptan imágenes, videos o PDF." }, 415);
